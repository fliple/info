...
function TokenPage({ address, history }) {
  ...
  return (
    <PageWrapper>
      ...
      <Warning
        type={'token'}
        show={!dismissed && listedTokens && !listedTokens.addresses.includes(address)}
      ...
      <ContentWrapper>
        ...
        <WarningGrouping disabled={!dismissed && listedTokens && !listedTokens.addresses.includes(address)}>
              ...
              >
                <TokenDetailsLayout>
                  ...
                  <ButtonLight color={backgroundColor}>
                    <Link color={backgroundColor} external href={`https://blockscout.com/poa/core/address/${address}`}>
                      View on Blockscout ↗
                    </Link>
                  </ButtonLight>
                </TokenDetailsLayout>
