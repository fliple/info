...
function PairPage({ pairAddress, history }) {
  ...
  return (
    <PageWrapper>
      ...
      <Warning
        type={'pair'}
        show={!dismissed && listedTokens && !(listedTokens.addresses.includes(token0?.id) && listedTokens.addresses.includes(token1?.id))}
      ...
      <ContentWrapperLarge>
        ...
        <WarningGrouping
          disabled={
            !dismissed && listedTokens && !(listedTokens.addresses.includes(token0?.id) && listedTokens.addresses.includes(token1?.id))
          }
        >
          <DashboardWrapper>
              ...
              >
                <TokenDetailsLayout>
                  ...
                  <ButtonLight color={backgroundColor}>
                    <Link color={backgroundColor} external href={`https://blockscout.com/poa/core/address/${pairAddress}`}>
                      View on Blockscout ↗
                    </Link>
                  </ButtonLight>
                </TokenDetailsLayout>
