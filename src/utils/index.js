...
export const urls = {
  showTransaction: (tx) => `https://blockscout.com/poa/core/tx/${tx}/`,
  showAddress: (address) => `https://blockscout.com/poa/core/address/${address}`,
  showToken: (address) => `https://blockscout.com/poa/core/tokens/${address}/`,
  showBlock: (block) => `https://blockscout.com/poa/core/blocks/${block}/`,
}
...
export const formattedNum = (number, usd = false, acceptNegatives = true) => {
  ...
  return Number(parseFloat(num).toFixed(6)).toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 6 })
}
